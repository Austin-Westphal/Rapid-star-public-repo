...
axios.get('https://api.github.com/repos/Austin-Westphal/rapid-star-bot-v1-0-0/releases/latest').then(res => {
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© RapidDevs | 2021 - ${new Date().getFullYear()}`))
